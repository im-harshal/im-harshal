...
* **[Treso](https://github.com/im-harshal/treso)** - Distributed personal finance **REST API** featuring event-driven architecture (Kafka), distributed API protection (Redis), and stateful Kubernetes orchestration.
* **[WikiRag](https://github.com/im-harshal/wiki-rag)** * - A **Retrieval-Augmented Generation (RAG)** chatbot that lets you ask questions over Wikipedia articles
